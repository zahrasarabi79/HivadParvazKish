...
const ReportPayment: React.FC<IReportPaymentComponent> = ({
  IsReturnPathName,
  remove,
  control,
  errors,
    ...
    <>
      <Grid item xs={IsReturnPathName ? 12 : mdDown ? 12 : 11.6}>
        <Grid
          ...
          sx={{
            pr: mdDown ? 0 : 2,
            borderRight: !mdDown && !IsReturnPathName ? "1px solid rgba(190,196,209,1)" : 0,
            borderBottom: mdDown && !IsReturnPathName ? "1px solid rgba(190,196,209,1)" : 0,
          }}
          spacing={1}
        >
            ...
            <TextFildControler
              ...
              helperText={
                errors.reports?.[reportIndex]?.reportsPayment?.[paymentIndex]?.paymentDescription
                  ? (errors.reports?.[reportIndex]?.reportsPayment?.[paymentIndex]?.paymentDescription as FieldError)
                      .message
                  : " "
              }
            />
