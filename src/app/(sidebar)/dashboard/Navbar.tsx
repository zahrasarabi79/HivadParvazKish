import { AppBar, Avatar, Fade, IconButton, Menu, MenuItem, Toolbar, Typography, useTheme } from "@mui/material";
...
export default function Navbar() {
  ...
  return (
    <AppBar position="fixed">
      <Toolbar variant="dense" sx={{ bgcolor: theme.palette.background.paper }}>
        {/* profile */}
        <IconButton>
          <Image
        ...
        >
          <MenuItem divider={true} sx={{ gap: 1 }}>
            <Avatar sx={{ width: 30, height: 30, bgcolor: theme.palette.primary.light }} alt={"zahra sarabi"} src="/static/images/avatar/1.jpg" />
